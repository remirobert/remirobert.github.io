...
;(function ($) {
    ...
    Remodal.prototype.buildDOM = function () {
        ...
        this.modalClose = $("<a href='#'>").addClass(pluginName + "-close").attr('id', 'pause-button');
    ...
    $(function(){
            ...
            function ready(player_id) {
              function setupEventListeners() {
                function onFinish() {
                  $f(player_id).addEvent('finish',
                  function(data) {
                    window.location.hash = "";
                    $('.arrow').addClass('show');
                    $('.remodal-overlay').hide();
                    $('body').css('.remodal_active','.remodal_lock');
                  });
                }
                onFinish();
              }
    ...
    Remodal.prototype.addEventListeners = function () {
        ...
        this.overlay.bind("click." + pluginName, function (e) {
            ...
            this.close();
            $f(document.getElementById('video')).api("pause");
        }.bind(this));
    };
